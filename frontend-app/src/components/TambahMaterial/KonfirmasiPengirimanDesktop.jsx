                ...
                <div className="lg:col-span-5 space-y-6">
                    ...
                    <div className="bg-white rounded-[24px] p-6 shadow-sm border border-gray-100">
                        <div className="flex justify-between items-center mb-5">
                            ...
                            <span className="bg-emerald-100 text-emerald-700 text-[8px] font-black px-2 py-1 rounded-full flex items-center gap-1"><ShieldCheck className="w-3 h-3"/> Terverifikasi RM & Tim SISAIN</span>
                        </div>
                ...
                <div className="lg:col-span-7 space-y-6">
                    ...
                    <div className="bg-white rounded-[24px] p-6 lg:p-8 shadow-sm border border-gray-100">
                        ...
                        <div className="space-y-3 mb-6">
                            {/* Checklist 1 */}
                            <div 
                                onClick={() => toggleChecklist('kondisi')}
                                className="bg-gray-50 rounded-xl p-4 flex gap-3 cursor-pointer hover:bg-gray-100 transition-colors border border-gray-100"
                            >
                                <div className={`w-5 h-5 rounded-md flex items-center justify-center shrink-0 mt-0.5 transition-colors ${checklist.kondisi ? 'bg-[#FFCC00]' : 'bg-white border-2 border-gray-300'}`}>
                                    {checklist.kondisi && <Check className="w-3.5 h-3.5 text-gray-900" strokeWidth={3}/>}
                                </div>
                                <div>
                                    <h4 className="text-[11px] font-black text-gray-900 mb-1">Kondisi Kering & Terlindung Cuaca</h4>
                                    <p className="text-[10px] text-gray-500 leading-relaxed">Material 4 sak semen diletakkan di tempat beratap dan tidak bersentuhan langsung dengan lantai basah.</p>
                                </div>
                            </div>

                            {/* Checklist 2 */}
                            <div 
                                onClick={() => toggleChecklist('akses')}
                                className="bg-gray-50 rounded-xl p-4 flex gap-3 cursor-pointer hover:bg-gray-100 transition-colors border border-gray-100"
                            >
                                <div className={`w-5 h-5 rounded-md flex items-center justify-center shrink-0 mt-0.5 transition-colors ${checklist.akses ? 'bg-[#FFCC00]' : 'bg-white border-2 border-gray-300'}`}>
                                    {checklist.akses && <Check className="w-3.5 h-3.5 text-gray-900" strokeWidth={3}/>}
                                </div>
                                <div>
                                    <h4 className="text-[11px] font-black text-gray-900 mb-1">Aksesibilitas Jalur Armada Siap</h4>
                                    <p className="text-[10px] text-gray-500 leading-relaxed">Kemasan utuh tersegel dan akses gang dapat dilalui armada roda tiga / motor kargo tanpa halangan portal.</p>
                                </div>
                            </div>

                            {/* Checklist 3 */}
                            <div 
                                onClick={() => toggleChecklist('pic')}
                                className="bg-gray-50 rounded-xl p-4 flex gap-3 cursor-pointer hover:bg-gray-100 transition-colors border border-gray-100"
                            >
                                <div className={`w-5 h-5 rounded-md flex items-center justify-center shrink-0 mt-0.5 transition-colors ${checklist.pic ? 'bg-[#FFCC00]' : 'bg-white border-2 border-gray-300'}`}>
                                    {checklist.pic && <Check className="w-3.5 h-3.5 text-gray-900" strokeWidth={3}/>}
                                </div>
                                <div>
                                    <h4 className="text-[11px] font-black text-gray-900 mb-1">Keberadaan PIC di Lokasi Penjemputan</h4>
                                    <p className="text-[10px] text-gray-500 leading-relaxed">Budi Santoso atau perwakilan gudang berada di tempat saat jam penjemputan (14.00 - 16.00 WIB).</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-[24px] p-5 flex justify-between items-center shadow-sm border border-gray-100">
                        ...
                        <button 
                            ...
                            className={`px-6 py-3.5 rounded-full text-xs font-black flex items-center gap-2 transition-all ${
                                isAllChecked 
